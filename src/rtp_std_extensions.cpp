...
const std::string RtpStandardExtensions::kExtSdesMid = "urn:ietf:params:rtp-hdrext:sdes:mid";
const std::string RtpStandardExtensions::kExtSdesRtpStreamId = "urn:ietf:params:rtp-hdrext:sdes:rtp-stream-id";
